...
CATS = [
 ...
 (f"{F}/frames_doc/master_frames_doc.jpg", "Документы, письма, журналы, открытки", "10 форматов",
 ...
 (f"{F}/frames_vinyl/master_frames_vinyl.jpg", "Пластинки", "9 форматов",
  ...
  [("Диптих", "бордовый · синий · бирюзовый бархат"),
   ("Только диск", "чёрная фактурная рама + красный"),
   ("Только конверт", "золото, орех, красное дерево + бордо, синий, серый")]),
 ...
 (f"{F}/frames_card/master_frames_card.jpg", "Карточки и слабы", "5 форматов",
 ...
 (f"{F}/frames_book/master_frames_book.jpg", "Книги", "6 форматов",
  "Основной формат — портрет автора рядом с раскрытой книгой в глубоком боксе: "
  "книга видна разворотом, а не корешком. Плоский вариант — подписанная страница "
  "рядом с портретом. Современная и поп-книга уходит от бархата к светлому "
  "паспарту и яркой раме под цвет обложки.",
  [("Глубокий бокс", "зелёный бархат, книга раскрыта, портрет рядом"),
   ("Плоско", "тёмная рама + красный бархат + портрет"),
   ("Современная", "жёлтая рама + белое паспарту")]),
 ...
 (f"{F}/stands_cap/master_stands_cap.jpg", "Кепки и козырьки", "акриловый бокс",
  "Формат нашёлся не на главном фото, а на втором-третьем кадре лота: кепка "
  "стоит в низком акриловом боксе на том же семействе оснований, что мяч и шайба. "
  "Латунная табличка с именем на передней грани.",
  [("Основания", "красное дерево · зелёный, белый мрамор · чёрный камень"),
   ("Подбор", "красная Ferrari — чёрное и зелёное, белая — дерево"),
   ("Табличка", "имя гонщика или теннисиста")]),

 (f"{F}/frames_art/master_frames_art.jpg", "Рисунки, эскизы, холсты", "5 форматов",
  "Рисунок и эскиз идут парой с портретом автора на бордовом бархате. "
  "Мелкий лист получает широкое синее паспарту и золотую линию — предмет "
  "выигрывает от воздуха. Холст в раму не убирают: его снимают в интерьере, "
  "на стене жилой комнаты или в зале.",
  [("Эскиз", "бордовый бархат + портрет автора"),
   ("Мелкий лист", "синее паспарту, широкие поля, золотая линия"),
   ("Холст", "интерьерный кадр, а не мольберт")]),

 (f"{F}/frames_cd/master_frames_cd.jpg", "Компакт-диски", "2 формата",
  "Тот же ход, что у пластинки, в меньшем размере: либо рама с фотографией "
  "и диском, либо раскрывающийся диптих на синем бархате.",
  [("Рама", "фото героя + диск, латунная табличка"),
   ("Диптих", "синий бархат, диск в нише"),
   ("Масштаб", "формат мельче — паспарту шире")]),
 ...
 (f"{F}/stands_boot/master_stands.jpg", "Бутсы и объёмные вещи", "6 оснований",
  ...
  [("Основания", "красное дерево ×3 · белый, чёрный, зелёный мрамор"),
   ("Шайбы и кепки", "то же семейство, куб или низкий бокс"),
   ("Табличка", "PERSONALLY SIGNED BY")]),
]
