...
- **ЗАПРЕТ на тему подлинности в текстах: не писать «подлинный автограф», «подлинность», «сертификат подлинности», «сертифицированный».** В Rolex не пишут, что часы настоящие, — это удешевляет. Конкретный сертификатор (JSA · PSA/DNA · Beckett) можно указать мелкой строкой как спецификацию, БЕЗ слова «подлинность». Вместо этого — понятные красивые тексты: факт, особенность, для какого интерьера/человека (кабинет, гостиная, клубная комната).
